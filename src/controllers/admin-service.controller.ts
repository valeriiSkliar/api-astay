...
import {AmenityRepository, ApartmentRepository, BookingRepository, ComplexRepository, LocationsRepository, RoomCategoryRepository, RoomTypeRepository} from '../repositories';
import {get, post} from '@loopback/rest';
import {Amenity, Apartment, Complex, Locations, RoomCategory, RoomType} from '../models';
...
export class AdminServiceController {
  ...
  async getDataForApartmentCreateForm(): Promise<IApartmentFormData>{
    ...
    return {complexes, roomTypes, roomCategories, locations, amenities, status: 200};
  }
}
