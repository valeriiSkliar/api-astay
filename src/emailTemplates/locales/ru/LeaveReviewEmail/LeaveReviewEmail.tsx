    ...
    <DefaultEmail lang="ru" previewText={previewText} hostData={data.hostContacts}>
      ...
      <Section>
        <Row>
          ...
          <Text>
            Мы надеемся, что во время вашего пребывания с нами у вас появились незабываемые воспоминания. Нам действительно было приятно принимать вас в нашем {headText}.
          </Text>
          <Text>
